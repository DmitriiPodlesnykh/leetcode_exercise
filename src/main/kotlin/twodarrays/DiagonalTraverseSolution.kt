...
class DiagonalTraverseSolution {
    ...
    fun findDiagonalOrder(matrix: Array<IntArray>): IntArray {
        ...
        val firstTriangleResult: FirstTriangleDataResponse = FirstTriangleSolution().prepare(matrix)
        return SecondTriangleSolution().prepare(firstTriangleResult, matrix)
    }
}